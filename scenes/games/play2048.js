...
class play2048 extends Phaser.Scene {
  ...
  create() {
    ...
    this.yOffset = 250;
   this.gridBack = this.add.image(0, this.yOffset, 'blank').setOrigin(0);
   this.gridBack.displayWidth = game.config.width;
   this.gridBack.displayHeight = twentyOptions.size.rows * (twentyOptions.tileSize + twentyOptions.tileSpacing) + 20
...
var title = this.add.bitmapText(game.config.width / 2, 100, 'topaz', '2048', 100).setOrigin(.5).setTint(0xc76210);
    ...
    this.fieldArray = [];
        ...
        this.score = 0
        this.scoreText = this.add.bitmapText(50, 1250, 'topaz', this.score, 120).setOrigin(0,.5).setTint(0xc76210);
        ...
        this.highText = this.add.bitmapText(850, 1250, 'topaz', this.highScore, 120).setOrigin(1,.5).setTint(0xc76210);
